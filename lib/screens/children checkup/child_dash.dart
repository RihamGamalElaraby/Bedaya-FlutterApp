              ...
              children: [
                mysignin(
                    ...
                    onPressed: () => Navigator.pushNamed(
                        context, childrenCheckup.screenRoute))
              ],
            ),
                    ...
                    child: Column(
                      children: [
                        Row(children: [
                          ...
                          Expanded(
                              child: defultText(data: 'Age', c: Colors.white)),
                          Expanded(
                              child: defultText(data: '...', c: Colors.white)),
                        ]),
                        Divider(
                                ...
                                children: [
                                  ...
                                  StreamBuilder(
                                    stream: selectedday == "all"
                                        ? MyDataBase.getAllPatientChild()
                                        : MyDataBase.getChildDash(selectedday),
                                    builder: (context, snapshot) {
                                      ...
                                      List<PatientChildModel> patient = snapshot
                                              .data?.docs
                                              .map((e) => e.data())
                                              .toList() ??
                                          [];
                                                                              ...
                                                                              builder: (BuildContext context) {
                                                                                return AlertDialog(
                                                                                  ...
                                                                                  actions: [
                                                                                    ...
                                                                                    TextButton(
                                                                                      onPressed: () {
                                                                                        MyDataBase.deleteChild(patient[index].codeChildPatient!);
                                                                                        Navigator.of(context).pop(); // Close the dialog
                                                                                      },
                                                                                      child: Text("Yes"),
                                                                                    ),
