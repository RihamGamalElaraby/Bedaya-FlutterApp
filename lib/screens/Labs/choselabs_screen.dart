                    ...
                    children: [
                      ...
                      Flexible(
                        child: mysignin(
                          ...
                          onPressed: () {
                            Navigator.pushNamed(
                                context, LabCheckout.screenRoute);
                          },
                        ),
                      ),
                      sizedBoxWidth(width: 20),
                      Flexible(
                        child: mysignin(
                          ...
                          title: 'Results',
                          onPressed: () {
                            Navigator.pushNamed(context, SelectLab.screenRoute);
                          },
                        ),
                      )
                    ],
                            ...
                            child: Column(
                              children: [
                                ...
                                Flexible(
                                    ...
                                    child: defultText(
                                        data:
                                            'Select patient do u need search for',
                                        c: Colors.black,
                                        x: 15)),
                                  ...
                                  viewportBuilder: (BuildContext context,
                                    ...
                                    return Column(
                                      children: [
                                        SizedBox(height: offset.pixels),
                                        StreamBuilder(
                                          stream: MyDataBase.getChildListUrine(
                                              true),
                                          builder: (context, snapshot) {
                                            if (snapshot.hasError) {
                                              return Center(
                                  ...
                                  viewportBuilder: (BuildContext context,
                                    ...
                                    return Column(
                                      children: [
                                        SizedBox(height: offset.pixels),
                                        StreamBuilder(
                                          stream: MyDataBase.getChildListBlood(
                                              true),
                                          builder: (context, snapshot) {
                                            if (snapshot.hasError) {
                                              return Center(
                                  ...
                                  viewportBuilder: (BuildContext context,
                                    ...
                                    return Column(
                                      children: [
                                        SizedBox(height: offset.pixels),
                                        StreamBuilder(
                                          stream: MyDataBase.getChildListStool(
                                              true),
                                          builder: (context, snapshot) {
                                            if (snapshot.hasError) {
                                              return Center(
