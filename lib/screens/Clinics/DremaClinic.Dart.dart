...
class _DermaClinicScreenState extends State<DermaClinicScreen> {
  ...
  List<String>SelectedCommondiagnosesforDerma = [];

  // String SelectedCommondiagnosesforDerma = '-';
  TextEditingController codeController = TextEditingController();
  TextEditingController dermadiagnoseController = TextEditingController();

  List<String> dermatreatment = ['misaclor','Cefrone',
                              ...
                              children: [
                                Flexible(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: TextFormField(
                                        controller: dermadiagnoseController,
                                        decoration: InputDecoration(
                                          labelText: 'Result',
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: DropDownMultiSelect(
                                        options: CommondiagnosesforDerma,
                                        selectedValues: SelectedCommondiagnosesforDerma,
                                        onChanged: (value) {
                                          setState(() {
                                            SelectedCommondiagnosesforDerma = value;
                                          });
                                          print('you have selected $SelectedCommondiagnosesforDerma fruits.');
                                        },
                                      ),
                                    ),
                                  ),
                ...
                children: [
                  Flexible(
                    ...
                    child: mysignin(
                      ...
                      onPressed: (){
                        setState(() {
                          CommondiagnosesforDerma.add(dermadiagnoseController.text);
                          dermatreatment.add(TreatmentController.text);
                          SelectedTreatment.add(TreatmentController.text);
                          SelectedCommondiagnosesforDerma.add(dermadiagnoseController.text);
                        });
                        patient.Dermadiagnoses = SelectedCommondiagnosesforDerma ;
                        patient.DermaTreatment =SelectedTreatment ;
