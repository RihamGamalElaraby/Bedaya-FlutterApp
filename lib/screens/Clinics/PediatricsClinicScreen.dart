...
class PediatricsClinicScreen extends StatefulWidget {
  static const String screenRoute = 'PediatricsClinicScreen';

  const PediatricsClinicScreen({Key? key}) : super(key: key);

  @override
  State<PediatricsClinicScreen> createState() => _PediatricsClinicScreenState();
}

class _PediatricsClinicScreenState extends State<PediatricsClinicScreen> {
  ...
  ['GASTROENTERITIS','PARASITES','TONSILITIS','UTI',
    ...
    ,'BRONCHIAL ASTHMA '];
  List<String> SelectedCommondiagnosesforPediatrics = [] ;
  // String SelectedCommondiagnosesforPediatrics = 'PARASITES';
  TextEditingController codeController = TextEditingController();
  TextEditingController peddiagnoseController = TextEditingController();

  List<String> pedtreatment = ['misaclor','Cefrone',
                ...
                children: [
                  Flexible(
                    ...
                    child: Container(
                      ...
                      width: 250,
                      child: Center(
                          child: Text('Pediatrics Clinic:', style: TextStyle(
                            color: Colors.white,
                              ...
                              children: [
                                Flexible(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: TextFormField(
                                        controller: peddiagnoseController,
                                        decoration: InputDecoration(
                                          labelText: 'Result',
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child:DropDownMultiSelect(
                                        options: CommondiagnosesforPediatrics,
                                        selectedValues: SelectedCommondiagnosesforPediatrics,
                                        onChanged: (value) {
                                          setState(() {
                                            SelectedCommondiagnosesforPediatrics = value;
                                          });
                                          print('you have selected $SelectedCommondiagnosesforPediatrics fruits.');
                                        },
                                      ),
                                    ),
                                  ),
                ...
                children: [
                  Flexible(
                    ...
                    child: mysignin(
                      ...
                      onPressed: (){
                        setState(() {
                          CommondiagnosesforPediatrics.add(peddiagnoseController.text);
                          pedtreatment.add(TreatmentController.text);
                          SelectedTreatment.add(TreatmentController.text);
                          SelectedCommondiagnosesforPediatrics.add(peddiagnoseController.text);
                        });
                        patient.peddiagnoses=SelectedCommondiagnosesforPediatrics;
                        patient.pedTreatment=SelectedTreatment;
