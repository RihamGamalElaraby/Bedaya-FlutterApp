                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: DropdownButton<String>(
                                        value: SelectedCommondiagnosesforPediatrics,
                                        items: CommondiagnosesforPediatrics.map((diagonoses) => DropdownMenuItem(
                                          value: diagonoses,
                                          child: Text(diagonoses ,style: TextStyle(
                                            color: Colors.black,),),),).toList(),
                                        onChanged: (diagonoses) => setState(() {
                                          SelectedCommondiagnosesforPediatrics =diagonoses!;
                                        },
                                        ),
                                      ),
                                    ),
