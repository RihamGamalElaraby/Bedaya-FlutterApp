...
class SurgeryClinicScreen extends StatefulWidget {
  static const String screenRoute = 'SurgeryClinicScreen';

  const SurgeryClinicScreen({Key? key}) : super(key: key);

  @override
  State<SurgeryClinicScreen> createState() => _SurgeryClinicScreenState();
}

class _SurgeryClinicScreenState extends State<SurgeryClinicScreen> {
  List<String> CommondiagnosesforSurgery =
  ['Lipoma','Abscess','Appendicitis','Cholecystitis',
    'Hernia','Thyroid goiter',];
  List<String> SelectedCommondiagnosesforSurgery = [];
  // String SelectedCommondiagnosesforSurgery = 'Lipoma';
  TextEditingController codeController = TextEditingController();
  TextEditingController surgerydiagnoseController = TextEditingController();

  List<String> Surgerytreatment = ['misaclor','Cefrone',
                ...
                children: [
                  Flexible(
                    ...
                    child: Container(
                      ...
                      width: 250,
                      child: Center(
                          child: Text('Surgery Clinic:', style: TextStyle(
                            color: Colors.white,
                              ...
                              children: [
                                Flexible(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: TextFormField(
                                        controller: surgerydiagnoseController,
                                        decoration: InputDecoration(
                                          labelText: 'Result',
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: DropDownMultiSelect(
                                        options: CommondiagnosesforSurgery,
                                        selectedValues: SelectedCommondiagnosesforSurgery,
                                        onChanged: (value) {
                                          setState(() {
                                            SelectedCommondiagnosesforSurgery = value;
                                          });
                                          print('you have selected $SelectedCommondiagnosesforSurgery fruits.');
                                        },
                                      ),
                                    ),
                                  ),
                ...
                children: [
                  Flexible(
                    ...
                    child: mysignin(
                      ...
                      onPressed: (){
                        setState(() {
                          CommondiagnosesforSurgery.add(surgerydiagnoseController.text);
                          SelectedTreatment.add(TreatmentController.text);
                          SelectedCommondiagnosesforSurgery.add(surgerydiagnoseController.text);
                          Surgerytreatment.add(TreatmentController.text);
                        });
                        patient.surgerydiagnoses=SelectedCommondiagnosesforSurgery;
                        patient.surgeryTreatment = SelectedTreatment;
