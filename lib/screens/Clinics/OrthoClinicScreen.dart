                ...
                children: [
                  Flexible(
                    ...
                    child: Container(
                      ...
                      width: 300,
                      child: Center(
                          child: Text('Orthopedics Clinic:', style: TextStyle(
                            color: Colors.white,
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: DropdownButton<String>(
                                        value: SelectedCommondiagnosesforOrtho,
                                        items: CommondiagnosesforOrtho.map((diagonoses) => DropdownMenuItem(
                                          value: diagonoses,
                                          child: Text(diagonoses ,style: TextStyle(
                                            color: Colors.black,),),),).toList(),
                                        onChanged: (diagonoses) => setState(() {
                                          SelectedCommondiagnosesforOrtho =diagonoses!;
                                        },
                                        ),
                                      ),
                                    ),
