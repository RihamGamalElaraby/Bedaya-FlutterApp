...
class OrthoClinicScreen extends StatefulWidget {
  static const String screenRoute = 'OrthoClinicScreen';

  const OrthoClinicScreen({Key? key}) : super(key: key);

  @override
  State<OrthoClinicScreen> createState() => _OrthoClinicScreenState();
}

class _OrthoClinicScreenState extends State<OrthoClinicScreen> {
  List<String> CommondiagnosesforOrtho =
  ['Osteoarthritis','Muscle Spasm','Slipped Disc','Sciatica','Joint Pain (low back/knee)','Gout',];
  List<String> SelectedCommondiagnosesforOrtho = [];
  // String SelectedCommondiagnosesforOrtho = 'Osteoarthritis';
  TextEditingController codeController = TextEditingController();
  TextEditingController orthodiagnoseController = TextEditingController();

  List<String> orthotreatment = ['misaclor','Cefrone',
                ...
                children: [
                  Flexible(
                    ...
                    child: Container(
                      ...
                      width: 250,
                      child: Center(
                          child: Text('Ortho Clinic:', style: TextStyle(
                            color: Colors.white,
                              ...
                              children: [
                                Flexible(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: TextFormField(
                                        controller: orthodiagnoseController,
                                        decoration: InputDecoration(
                                          labelText: 'Result',
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: DropDownMultiSelect(
                                        options: CommondiagnosesforOrtho,
                                        selectedValues: SelectedCommondiagnosesforOrtho,
                                        onChanged: (value) {
                                          setState(() {
                                            SelectedCommondiagnosesforOrtho = value;
                                          });
                                          print('you have selected $SelectedCommondiagnosesforOrtho .');
                                        },
                                      ),
                                    ),
                                  ),
                ...
                children: [
                  Flexible(
                    ...
                    child: mysignin(
                      ...
                      onPressed: (){
                        setState(() {
                          CommondiagnosesforOrtho.add(orthodiagnoseController.text);
                          orthotreatment.add(TreatmentController.text);
                          SelectedTreatment.add(TreatmentController.text);
                          SelectedCommondiagnosesforOrtho.add(orthodiagnoseController.text);
                        });
                        patient.orthodiagnoses=SelectedCommondiagnosesforOrtho;
                        patient.orthoTreatment=SelectedTreatment;
