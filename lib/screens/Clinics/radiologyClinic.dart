...
class RadiologyClinicScreen extends StatefulWidget {
  static const String screenRoute = 'RadiologyClinicScreen';

  const RadiologyClinicScreen({Key? key}) : super(key: key);

  @override
  State<RadiologyClinicScreen> createState() => _RadiologyClinicScreenState();
}

class _RadiologyClinicScreenState extends State<RadiologyClinicScreen> {
                        ...
                        child: Column(
                          children: [
                            ...
                            Flexible(
                                ...
                                child: defultText(
                                    data:
                                        'Select patientAd do u need search for',
                                    c: Colors.black,
                                    x: 15)),
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: DropDownMultiSelect(
                                        ...
                                        selectedValues:
                                            SelectedCommondiagnosesforDental,
                                        onChanged: (value) {
                                          setState(() {
                                            SelectedCommondiagnosesforDental =
                                                value;
                                          ...
                                          print(
                                              'you have selected $SelectedCommondiagnosesforDental .');
                                        },
                                      ),
                                    ),
                                  ),
                                    ...
                                    child: Center(
                                      child: DropDownMultiSelect(
                                        ...
                                        onChanged: (value) {
                                          ...
                                          print(
                                              'you have selected $SelectedTreatment ');
                                        },
                                      ),
                                    ),
                                  ),
                ...
                children: [
                  Flexible(
                    ...
                    child: mysignin(
                      ...
                      onPressed: () {
                        setState(() {
                          CommondiagnosesforDental.add(
                              dentaldiagnoseController.text);
                          Dentaltreatment.add(TreatmentController.text);
                          SelectedCommondiagnosesforDental.add(
                              dentaldiagnoseController.text);
                          SelectedTreatment.add(TreatmentController.text);
                        });
                        patientAd.Radiologyiagnoses =
                            SelectedCommondiagnosesforDental;
                        patientAd.Radiologytreatment = SelectedTreatment;
                        patientAd.reportRadiologydiagnoses = "done";
                        MyDataBase.updatePatientAdult(patientAd);
                        // child
                        patientCh.Radiologyiagnoses =
                            SelectedCommondiagnosesforDental;
                        patientCh.Radiologytreatment = SelectedTreatment;
                        patientCh.reportRadiologydiagnoses = "done";
                        MyDataBase.updatePatientChild(patientCh);
                        clearTextField(
                            TreatmentController, dentaldiagnoseController);
                        clearList(SelectedTreatment,
                            SelectedCommondiagnosesforDental);
                        ...
                        children: [
                          ...
                          Flexible(
                              child: IconButton(
                                  onPressed: () {
                                    Navigator.pushNamed(
                                        context, ClinicScreenChose.screenRoute);
                                  },
                                  icon: Icon(Icons.add)))
                        ],
                      ),
