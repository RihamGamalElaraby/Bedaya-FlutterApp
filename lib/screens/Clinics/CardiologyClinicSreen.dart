                ...
                children: [
                  Flexible(
                    ...
                    child: Container(
                      ...
                      width: 300,
                      child: Center(
                          child: Text('Cardiology Clinic:', style: TextStyle(
                            color: Colors.white,
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: DropdownButton<String>(
                                        value: SelectedCommondiagnosesforCardio,
                                        items: CommondiagnosesforCardio.map((diagonoses) => DropdownMenuItem(
                                          value: diagonoses,
                                          child: Text(diagonoses ,style: TextStyle(
                                            color: Colors.black,),),),).toList(),
                                        onChanged: (diagonoses) => setState(() {
                                          SelectedCommondiagnosesforCardio =diagonoses!;
                                        },
                                        ),
                                      ),
                                    ),
