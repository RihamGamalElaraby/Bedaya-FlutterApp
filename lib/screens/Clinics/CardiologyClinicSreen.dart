...
class CardioScreen extends StatefulWidget {
  static const String screenRoute = 'CardioScreen';
...
class _CardioScreenState extends State<CardioScreen> {
  ...
  List<String> SelectedCommondiagnosesforCardio =[];


  List<String> Cardiotreatment = ['misaclor','Cefrone',
  ...
  TextEditingController CardiodiagnoseController = TextEditingController();
                ...
                children: [
                  Flexible(
                    ...
                    child: Container(
                      ...
                      width: 250,
                      child: Center(
                          child: Text('CARDIO Clinic:', style: TextStyle(
                            color: Colors.white,
                              ...
                              children: [
                                Flexible(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: TextFormField(
                                        controller: CardiodiagnoseController,
                                        decoration: InputDecoration(
                                          labelText: 'Result',
                                ...
                                Flexible(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child:
                                      DropDownMultiSelect(
                                        options: CommondiagnosesforCardio,
                                        selectedValues: SelectedCommondiagnosesforCardio,
                                        onChanged: (value) {
                                          setState(() {
                                            SelectedCommondiagnosesforCardio = value;
                                          });
                                          print('you have selected $SelectedCommondiagnosesforCardio fruits.');
                                        },
                                      ),
                                    ),
                                  ),
                  ...
                  Flexible(
                    ...
                    child: mysignin(
                      ...
                      onPressed: (){
                        ...
                        setState(() {
                          CommondiagnosesforCardio.add(CardiodiagnoseController.text);
                          Cardiotreatment.add(TreatmentController.text);
                          SelectedTreatment.add(TreatmentController.text); // tohfa wlahyy
                          SelectedCommondiagnosesforCardio.add(CardiodiagnoseController.text);

                        });
                         patient.Cardiodiagnoses = SelectedCommondiagnosesforCardio ;
                         patient.CardioTreatment =  SelectedTreatment;
                        MyDataBase.updatePatientAdult(patient);
                        clearTextField(TreatmentController, CardiodiagnoseController);
                        SelectedTreatment.clear() ;
                        SelectedCommondiagnosesforCardio.clear();
