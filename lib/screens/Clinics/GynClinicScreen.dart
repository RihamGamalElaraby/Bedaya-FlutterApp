...
class GynClinicScreen extends StatefulWidget {
  static const String screenRoute = 'GynClinicScreen';

  const GynClinicScreen({Key? key}) : super(key: key);

  @override
  State<GynClinicScreen> createState() => _GynClinicScreenState();
}

class _GynClinicScreenState extends State<GynClinicScreen> {
  ...
  List<String> SelectedCommondiagnosesforGyn = [];
                ...
                children: [
                  Flexible(
                    ...
                    child: Container(
                      ...
                      width: 250,
                      child: Center(
                          child: Text('Gynecology Clinic:', style: TextStyle(
                            color: Colors.white,
                              ...
                              children: [
                                Flexible(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: TextFormField(
                                        controller: gyndiagnoseController,
                                        decoration: InputDecoration(
                                          labelText: 'Result',
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child:DropDownMultiSelect(
                                        options: CommondiagnosesforGyn ,
                                        selectedValues: SelectedCommondiagnosesforGyn ,
                                        onChanged: (value) {
                                          setState(() {
                                            SelectedCommondiagnosesforGyn = value;
                                          });
                                          print('you have selected $SelectedCommondiagnosesforGyn fruits.');
                                        },
                                      ),
                                    ),
                                  ),
                ...
                children: [
                  Flexible(
                    ...
                    child: mysignin(
                      ...
                      onPressed: (){
                        setState(() {
                          CommondiagnosesforGyn.add(gyndiagnoseController.text);
                          gyntreatment.add(TreatmentController.text);
