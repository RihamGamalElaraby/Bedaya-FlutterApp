                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: DropdownButton<String>(
                                        value: SelectedCommondiagnosesforOphthalmology,
                                        items: CommondiagnosesforOphthalmology.map((diagonoses) => DropdownMenuItem(
                                          value: diagonoses,
                                          child: Text(diagonoses ,style: TextStyle(
                                            color: Colors.black,),),),).toList(),
                                        onChanged: (diagonoses) => setState(() {
                                          SelectedCommondiagnosesforOphthalmology =diagonoses!;
                                        },
                                        ),
                                      ),
                                    ),
