...
class reportday3 extends StatefulWidget {
  static const String screenRoute = "reportday3";

  const reportday3({super.key});

  @override
  State<reportday3> createState() => _reportday3State();
}

class _reportday3State extends State<reportday3> {
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: defultText(data: "Day 3", c: Colors.black, x: 24),
                        ),
                        const Divider(
                          height: 2,
                          color: Colors.white,
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultDash("Day 3"),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              sizedBoxWidth(width: 15),
                              StreamBuilder(
                                stream: MyDataBase.getChildDash("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultUrineReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildUrineReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultBloodReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildBloodReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultPharmacyReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildPharmacyReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultUrineAbnormalCalcium("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildUrineAbnormalCalcium("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultUrineAbnormalUricacid("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildUrineAbnormalUricacid("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultUrineAbnormalTriplephosphate("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildUrineAbnormalTriplephosphate("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultUrineAbnormalAmorphous("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildUrineAbnormalAmorphous("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalFasciola("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalFasciola("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalSchMansoni("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalSchMansoni("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalHNana("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalHNana("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalTinea("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalTinea("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalAscaris("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalAscaris("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalTtrichuria("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalTtrichuria("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalBlostocyt("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalBlostocyt("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalHookworm("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalHookworm("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalEntrobious("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalEntrobious("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalEcoli("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalEcoli("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalEhistolitica("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalEhistolitica("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalGiardia("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalGiardia("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalStrongyloideslarvae("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalStrongyloideslarvae("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalGiardiatrophozozite("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalGiardiatrophozozite("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalEhistoliticatrophozite("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalEhistoliticatrophozite("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder<int>(
                                stream: MyDataBase().getChildParasite("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Text("error");
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultIMReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildIMReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultCardioReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildCardioReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultSurgeryReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildSurgeryReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultOpthaReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildOpthaReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                            ...
                            children: [
                              ...
                              Expanded(
                                  child: defultText(
                                      ...
                                      x: 18)),
                              StreamBuilder(
                                stream: MyDataBase.getAdultGynReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildGynReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultEntReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildEntReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                            ...
                            children: [
                              ...
                              Expanded(
                                  child: defultText(
                                      ...
                                      x: 18)),
                              StreamBuilder(
                                stream: MyDataBase.getAdultPedReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildPedReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultDermaReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildDermaReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultOrthoReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildOrthoReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultDentalReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildDentalReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultFollowUoReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildFollowUoReport("Day 3"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
