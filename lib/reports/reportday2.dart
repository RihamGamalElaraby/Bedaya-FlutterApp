...
class reportday2 extends StatefulWidget {

  static const String screenRoute = "reportday2";
  const reportday2({super.key});
  @override
  State<reportday2> createState() => _reportday2State();
}

class _reportday2State extends State<reportday2> {
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: defultText(data: "Day 2", c: Colors.black, x: 24),
                        ),
                        const Divider(
                          height: 2,
                          color: Colors.white,
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultDash("Day 2"),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              sizedBoxWidth(width: 15),
                              StreamBuilder(
                                stream: MyDataBase.getChildDash("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultUrineReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildUrineReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultBloodReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildBloodReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultPharmacyReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildPharmacyReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultUrineAbnormalCalcium("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildUrineAbnormalCalcium("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultUrineAbnormalUricacid("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildUrineAbnormalUricacid("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultUrineAbnormalTriplephosphate("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildUrineAbnormalTriplephosphate("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultUrineAbnormalAmorphous("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildUrineAbnormalAmorphous("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalFasciola("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalFasciola("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalSchMansoni("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalSchMansoni("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalHNana("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalHNana("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalTinea("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalTinea("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalAscaris("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalAscaris("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalTtrichuria("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalTtrichuria("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalBlostocyt("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalBlostocyt("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalHookworm("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalHookworm("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalEntrobious("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalEntrobious("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalEcoli("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalEcoli("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalEhistolitica("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalEhistolitica("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalGiardia("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalGiardia("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalStrongyloideslarvae("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalStrongyloideslarvae("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalGiardiatrophozozite("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalGiardiatrophozozite("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalEhistoliticatrophozite("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalEhistoliticatrophozite("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder<int>(
                                stream: MyDataBase().getChildParasite("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Text("error");
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultIMReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildIMReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultCardioReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildCardioReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultSurgeryReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildSurgeryReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultOpthaReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildOpthaReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                            ...
                            children: [
                              ...
                              Expanded(
                                  child: defultText(
                                      ...
                                      x: 18)),
                              StreamBuilder(
                                stream: MyDataBase.getAdultGynReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildGynReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultEntReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildEntReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                            ...
                            children: [
                              ...
                              Expanded(
                                  child: defultText(
                                      ...
                                      x: 18)),
                              StreamBuilder(
                                stream: MyDataBase.getAdultPedReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildPedReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultDermaReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildDermaReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultOrthoReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildOrthoReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultDentalReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildDentalReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultFollowUoReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildFollowUoReport("Day 2"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
