...
class reportday4 extends StatefulWidget {
  static const String screenRoute = "reportday4";

  const reportday4({super.key});


  @override
  State<reportday4> createState() => _reportday4State();
}

class _reportday4State extends State<reportday4> {
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: defultText(data: "Day 4", c: Colors.black, x: 24),
                        ),
                        const Divider(
                          height: 2,
                          color: Colors.white,
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultDash("Day 4"),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              sizedBoxWidth(width: 15),
                              StreamBuilder(
                                stream: MyDataBase.getChildDash("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultUrineReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildUrineReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultBloodReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildBloodReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultPharmacyReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildPharmacyReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultUrineAbnormalCalcium("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildUrineAbnormalCalcium("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultUrineAbnormalUricacid("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildUrineAbnormalUricacid("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultUrineAbnormalTriplephosphate("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildUrineAbnormalTriplephosphate("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultUrineAbnormalAmorphous("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildUrineAbnormalAmorphous("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalFasciola("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalFasciola("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalSchMansoni("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalSchMansoni("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalHNana("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalHNana("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalTinea("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalTinea("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalAscaris("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalAscaris("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalTtrichuria("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalTtrichuria("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalBlostocyt("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalBlostocyt("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalHookworm("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalHookworm("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalEntrobious("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalEntrobious("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalEcoli("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalEcoli("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalEhistolitica("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalEhistolitica("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalGiardia("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalGiardia("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalStrongyloideslarvae("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalStrongyloideslarvae("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalGiardiatrophozozite("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalGiardiatrophozozite("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultStoolAbnormalEhistoliticatrophozite("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildStoolAbnormalEhistoliticatrophozite("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder<int>(
                                stream: MyDataBase().getChildParasite("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Text("error");
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultIMReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildIMReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultCardioReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildCardioReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultSurgeryReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildSurgeryReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultOpthaReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildOpthaReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                            ...
                            children: [
                              ...
                              Expanded(
                                  child: defultText(
                                      ...
                                      x: 18)),
                              StreamBuilder(
                                stream: MyDataBase.getAdultGynReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildGynReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultEntReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildEntReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                            ...
                            children: [
                              ...
                              Expanded(
                                  child: defultText(
                                      ...
                                      x: 18)),
                              StreamBuilder(
                                stream: MyDataBase.getAdultPedReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildPedReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultDermaReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildDermaReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultOrthoReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildOrthoReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultDentalReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildDentalReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getAdultFollowUoReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    print(snapshot.error);
                                    return Center(
                              ...
                              StreamBuilder(
                                stream: MyDataBase.getChildFollowUoReport("Day 4"),
                                builder: (context, snapshot) {
                                  if (snapshot.hasError) {
                                    return Center(
                                        child: Text(
