...
class PediatricFollowupscreen extends StatefulWidget {
  ...
  const PediatricFollowupscreen({Key? key}) : super(key: key);
...
List<String> SelectedPediatricFollowupNeedcheckup =[];

List<String> PediatricFollowupNeedinvestigations =
['MRI',];
List<String> SelectedPediatricFollowupNeedinvestigations =[];


List<String> PediatricFollowupdontNeedoperation =
['Tonsillectomy','Adenectomy','Undescended Testes','Plastic Surgery(cleft palate)',
'Plastic Surgery(post burn contraction)','Plastic Surgery(well defined soft tissue)',
'For Circumcision','Neurosurgery (Predicted Consulration)',
  'Surgical excision of subcutaneous lipoma','Inguinal Hernia','Paraumbilical Hernia','Pectus exacavatum'];
List<String> SelectedPediatricFollowupNeedoperation =[];
...
class _PediatricFollowupscreenState extends State<PediatricFollowupscreen> {
  @override
                                ...
                                Flexible(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child:
                                      DropDownMultiSelect(
                                        options: PediatricFollowupNeedcheckup,
                                        selectedValues:SelectedPediatricFollowupNeedcheckup ,
                                        onChanged: (value) {
                                          setState(() {
                                            SelectedPediatricFollowupNeedcheckup = value;
                                          });
                                        },
                                      ),
                                    ),
                                ...
                                Flexible(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child:
                                      DropDownMultiSelect(
                                        options: PediatricFollowupNeedinvestigations,
                                        selectedValues: SelectedPediatricFollowupNeedinvestigations,
                                        onChanged: (value) {
                                          setState(() {
                                            SelectedPediatricFollowupNeedinvestigations = value;
                                          });
                                        },
                                      ),
                                    ),
                                ...
                                Flexible(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child:
                                      DropDownMultiSelect(
                                        options: PediatricFollowupdontNeedoperation,
                                        selectedValues: SelectedPediatricFollowupNeedoperation,
                                        onChanged: (value) {
                                          setState(() {
                                            SelectedPediatricFollowupNeedoperation = value;
                                          });
                                        },
                                      ),
                                    ),
