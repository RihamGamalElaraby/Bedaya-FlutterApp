...
['Entropion','Ectropion','Dacryocystorhinostomy (DCR)','Squint',
  'Distichiasis','Phacoemulsification','Amblyopia','Glaucoma','Blepharoplasty','Atrophic Bulbi'
  ,'Central Corneal Opacity','Occuloplasty for prosthetic eye','Opacified IOL'];
...
class _OphthalmologyFollowupScreenState extends State<OphthalmologyFollowupScreen> {
  @override
  List<Widget> rows = [];
                          ...
                          children: [
                            ...
                            Flexible(
                                ...
                                child: Container(
                                    ...
                                    child: Center(
                                      child: defultText(
                                          data: 'عمليات لها قرارات علي نفقة الدولة',
                                          c: Colors.white),
                                    ))),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                                ...
                                Flexible(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child:
                                      DropDownMultiSelect(
                                        options: OphthalmologyFollowupNeeddesicion,
                                        selectedValues: SelectedOphthalmologyFollowupNeeddesicion,
                                        onChanged: (value) {
                                          setState(() {
                                            SelectedOphthalmologyFollowupNeeddesicion = value;
                                          });
                                        },
                                      ),
                                    ),
                            ...
                            Flexible(
                                ...
                                child: Container(
                                    ...
                                    child: Center(
                                      child: defultText(
                                          data: 'عمليات ليس لها قرار علي نفقة الدولة',
                                          c: Colors.white),
                                    ))),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                                ...
                                Flexible(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child:
                                      DropDownMultiSelect(
                                        options: OphthalmologyFollowupdontNeeddesicion,
                                        selectedValues: SelectedOphthalmologyFollowupdontNeeddesicion,
                                        onChanged: (value) {
                                          setState(() {
                                            SelectedOphthalmologyFollowupdontNeeddesicion = value;
                                          });
                                        },
                                      ),
                                    ),
