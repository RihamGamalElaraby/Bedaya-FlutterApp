...
class ENTFollowUpscreen extends StatefulWidget {
  static const String screenRoute = 'ENTFollowUpscreen';

  const ENTFollowUpscreen({Key? key}) : super(key: key);

  @override
  State<ENTFollowUpscreen> createState() => _ENTFollowUpscreenState();
}
...
['MRI temporal','CT temporal','Videopharygescopy','Videopharygescopy',];
List<String> SelectedENTFollowupNeedinvestigations =[];
...
class _ENTFollowUpscreenState extends State<ENTFollowUpscreen> {
  @override
  List<Widget> rows = [];
                                ...
                                Flexible(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child:
                                      DropDownMultiSelect(
                                        options: ENTFollowupNeedinvestigations,
                                        selectedValues: SelectedENTFollowupNeedinvestigations,
                                        onChanged: (value) {
                                          setState(() {
                                            SelectedENTFollowupNeedinvestigations = value;
                                          });
                                        },
                                      ),
                                    ),
                                ...
                                Flexible(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child:
                                      DropDownMultiSelect(
                                        options: ENTFollowupNeedoperations,
                                        selectedValues: SelectedENTFollowupNeedoperations,
                                        onChanged: (value) {
                                          setState(() {
                                            SelectedENTFollowupNeedoperations = value;
                                          });
                                        },
                                      ),
                                    ),
